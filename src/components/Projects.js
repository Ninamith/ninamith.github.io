                    ...
                    <Grid container spacing={3}>
                            ...
                            <Card className={classes.secondaryRoot}>
                                ...
                                <CardActions>
                                    <Button size="medium" color="primary">
                                        <a href="https://github.com/Ninamith/Alexa">Learn More on Github</a>
                                    </Button>
                                </CardActions>
                            </Card>
                        </Grid>
                        <Grid item xs>
                            <Card className={classes.secondaryRoot}>
                                ...
                                <CardActions>
                                    <Button size="medium" color="primary">
                                        <a href="https://github.com/Ninamith/Ver1.0">Learn More on Github</a>
                                    </Button>
                                </CardActions>
                            </Card>
                        </Grid>
                        <Grid item xs>
                            <Card className={classes.secondaryRoot}>
                                <CardActionArea>
                                    ...
                                    <CardContent>
                                        <Typography gutterBottom variant="h4" component="h2">
                                        TD’S ASL Helper (Hack the North 2018 – Canada’s largest hackathon)
          </Typography>
                                        <Typography variant="h5" color="textSecondary" component="p">
                                ...
                                <CardActions>
                                    <Button size="medium" color="primary">
                                        <a href="https://github.com/Ninamith/camera">Learn More on Github</a>
                                    </Button>
                                </CardActions>
                            </Card>
                        </Grid>
                        ...
                        <Grid item xs={4}>
                            <Card className={classes.secondaryRoot}>
                                <CardActionArea>
                                    ...
                                    <CardContent>
                                        <Typography gutterBottom variant="h4" component="h2">
                                        BiQuadris (made in Object Oriented Programming course)
          </Typography>
                                        <Typography variant="h5" color="textSecondary" component="p">
                                ...
                                <CardActions>
                                    <Button size="medium" color="primary">
                                    <a href="#about">Request source code via email (private github repo due to school policy)</a>
                                    </Button>
                                </CardActions>
                            </Card>
                        </Grid>
